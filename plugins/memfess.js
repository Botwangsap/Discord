...
let handler = async (m, { conn, text, usedPrefix, command }) => {
   ...
   if (jid == m.sender) throw 'tidak bisa mengirim pesan menfess ke diri sendiri.'
    ...
    try {
        ...
        await conn.reply(data.jid, txt, m, { contextInfo: { externalAdReply: {title: global.wm, body: 'Lisabotz-MD😍🥰🍭', sourceUrl: global.snh, thumbnail: fs.readFileSync('./thumbnail.jpg') }}})
        .then(() => {
