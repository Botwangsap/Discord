...
const fgclink = {
  ...
  if (rown) return conn.reply(m.chat, rown, m, { contextInfo: { externalAdReply: {title: global.wm, body: 'Lisabotz-MD', sourceUrl: global.snh, thumbnail: fs.readFileSync('./1684450933508.jpg') }}})

        
let own = {
owner: '*OWNER ONLY* • COMMAND INI HANYA UNTUK OWNER BOT'}[type]
  if (own) return conn.reply(m.chat, own, m, { contextInfo: { externalAdReply: {title: global.wm, body: 'Lisabotz-MD', sourceUrl: global.snh, thumbnail: fs.readFileSync('./1684450933508.jpg') }}})

let mod = {
mods: '*MODERATOR ONLY* • COMMAND INI HANYA UNTUK MODERATOR'}[type]
  if (mod) return conn.reply(m.chat, mod, m, { contextInfo: { externalAdReply: {title: global.wm, body: 'Lisabotz-MD', sourceUrl: global.snh, thumbnail: fs.readFileSync('./1684450933508.jpg') }}})

let prm = {
        premium: '*PREMIUM ONLY* • COMMAND INI HANYA UNTUK PREMIUM USER'}[type]
  if (prm) return conn.reply(m.chat, prm, m, { contextInfo: { externalAdReply: {title: global.wm, body: 'Lisabotz-MD', sourceUrl: global.snh, thumbnail: fs.readFileSync('./1684450933508.jpg') }}})

let gc = {
        group: '*GROUP CHAT* • COMMAND INI HANYA BISA DIGUNAKAN DIDALAM GRUP'
        }[type]
  if (gc) return conn.reply(m.chat, gc, m, { contextInfo: { externalAdReply: {title: global.wm, body: 'Lisabotz-MD', sourceUrl: global.snh, thumbnail: fs.readFileSync('./1684450933508.jpg') }}})
...
let msg = {
  ...
  if (msg) return conn.reply(m.chat, msg, m, { contextInfo: { externalAdReply: {title: global.wm, body: 'Lisabotz-MD', sourceUrl: global.snh, thumbnail: fs.readFileSync('./1684450933508.jpg') }}})
  
  
    let msgg = {
    	unreg: 'Halo Kak 👋\nAnda harus mendaftar ke database dulu sebelum menggunakan fitur ini\n\n➞ Ketik .register untuk mendaftar'
}[type]
if (msgg) return conn.reply(m.chat, msgg, m, { contextInfo: { externalAdReply: {title: global.wm, body: 'Lisabotz-MD', sourceUrl: global.snh, thumbnail: fs.readFileSync('./1684450933508.jpg') }}})
}
function ucapan() {
